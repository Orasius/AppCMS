                ...
                initialize:function(){
                            Ext.Ajax.request({
                   				...
                   				var b7;
                                                ...
                                                dataValue = getPageData(Services,response.responseText);
                                                ...
                                                for(m=0;m<navValues.length;m++)
                                                {
                                                       ...
                                                       if(m == 0)
                                                       {
                                                            ...
                                                            {
                                                                    Ext.getCmp('Services').add(
                                                                                  {
                                                                                  xtype: 'button',
                                                                                  text: buttonValues[0],
                                                                                  ui: 'round',
                                                                                  handler: function(){
                                                                                          this.up('servicesView').push({xtype: b0})
                                                                                  }});
                                                            }
                                                            if(buttonValues[1] == 'url')
                                                            {
                                                                    Ext.getCmp('Services').add(
                                                                                  {
                                                                                  xtype: 'button',
                                                       ...
                                                       if(m == 1)
                                                       {
                                                            ...
                                                            if(buttonValues[1] == 'page')
                                                            {
                                                                    Ext.getCmp('Services').add(
                                                                                  ...
                                                                                  ui: 'round',
                                                                                  handler: function(){
                                                                                          this.up('servicesView').push({xtype: b1})
                                                                                  }});
                                                            }
                                                            if(buttonValues[1] == 'url')
                                                            {
                                                       ...
                                                       if(m == 2)
                                                       {
                                                            ...
                                                            if(buttonValues[1] == 'page')
                                                            {
                                                                    Ext.getCmp('Services').add(
                                                                                  ...
                                                                                  ui: 'round',
                                                                                  handler: function(){
                                                                                          this.up('servicesView').push({xtype: b2})
                                                                                  }});
                                                            }
                                                            if(buttonValues[1] == 'url')
                                                            {
                                                       ...
                                                       if(m == 3)
                                                       {
                                                            ...
                                                            if(buttonValues[1] == 'page')
                                                            {
                                                                    Ext.getCmp('Services').add(
                                                                                  ...
                                                                                  ui: 'round',
                                                                                  handler: function(){
                                                                                          this.up('servicesView').push({xtype: b3})
                                                                                  }});
                                                            }
                                                            if(buttonValues[1] == 'url')
                                                            {
                                                       ...
                                                       if(m == 4)
                                                       {
                                                            ...
                                                            if(buttonValues[1] == 'page')
                                                            {
                                                                    Ext.getCmp('Services').add(
                                                                                  ...
                                                                                  ui: 'round',
                                                                                  handler: function(){
                                                                                          this.up('servicesView').push({xtype: b4})
                                                                                  }});
                                                            }
                                                            if(buttonValues[1] == 'url')
                                                            {
                                                       ...
                                                       if(m == 5)
                                                       {
                                                            ...
                                                            if(buttonValues[1] == 'page')
                                                            {
                                                                    Ext.getCmp('Services').add(
                                                                                  ...
                                                                                  ui: 'round',
                                                                                  handler: function(){
                                                                                          this.up('servicesView').push({xtype: b5})
                                                                                  }});
                                                            }
                                                            if(buttonValues[1] == 'url')
                                                            {
                                                      ...
                                                      if(m == 6)
                                                       {
                                                            ...
                                                            if(buttonValues[1] == 'page')
                                                            {
                                                                    Ext.getCmp('Services').add(
                                                                                  ...
                                                                                  ui: 'round',
                                                                                  handler: function(){
                                                                                          this.up('servicesView').push({xtype: b6})
                                                                                  }});
                                                            }
                                                            if(buttonValues[1] == 'url')
                                                            {
