...
<style>
			...
			#vertical_sortable li { margin: 0 3px 3px 3px; padding: 0.4em; padding-left: 1.5em; font-size: 1.4em; height: 28px; }
...
<!--[if lt IE 9]>
<script type="text/javascript" src="{base}plugins/flot/excanvas.min.js"></script>
<![endif]-->
...
<script type="text/javascript" src="{base}js/core/themer.js"></script>

<!-- Demo Scripts (remove if not needed) -->
<script type="text/javascript" src="{base}js/demo/demo.js"></script>

<!-- <script src="http://js.nicedit.com/nicEdit-latest.js" type="text/javascript"></script>-->
<!--<script src="http://code.jquery.com/ui/1.8.20/jquery-ui.min.js" type="text/javascript"></script>-->
<script type="text/javascript" src="/cms/3rdparty/ckeditor/ckeditor.js"></script>
...
<script language="javascript" type="text/javascript" src="{base}jqplot/jquery.jqplot.min.js"></script>
<link rel="stylesheet" type="text/css" href="{base}jqplot/jquery.jqplot.css" />
<!-- jqPlot Plugins -->
<script type="text/javascript" src="{base}jqplot/plugins/jqplot.highlighter.min.js"></script>
<script type="text/javascript" src="{base}jqplot/plugins/jqplot.cursor.min.js"></script>
<script type="text/javascript" src="{base}jqplot/plugins/jqplot.dateAxisRenderer.min.js"></script>
<!--
<script type="text/javascript" src="{base}jqplot/plugins/jqplot.canvasTextRenderer.min.js"></script>
<script type="text/javascript" src="{base}jqplot/plugins/jqplot.canvasAxisLabelRenderer.min.js"></script>
-->
	...
	<div id="mws-header" class="clearfix">
    	...
    	<div id="mws-logo-container">
        	...
        	<div id="mws-logo-wrap">
            	<img src="{base}images/appcms.png" width="180" height="50" />
			</div>
        </div>
